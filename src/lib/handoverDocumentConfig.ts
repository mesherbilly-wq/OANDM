...
export const FALLBACK_DOCUMENT_DEFINITIONS: HandoverDocumentDefinition[] = [
  fallbackDefinition('sdp', PROJECT_WIDE_DOCUMENT_TYPE_KEY, 'System Design Proposal (SDP)', 'Editable proposed or as-fitted scope from the Simpro job. Signatures bind this revision only.', 'file', { sc_enabled: true, required: true, display_order: 5, sc_template_id: 'sdp' }),
  fallbackDefinition('cc01_completion', 'cctv', 'CC01 CCTV completion and handover', 'One standalone NCP 104 record. Engineer and customer sign on this sheet only.', 'clipboard', { sc_enabled: true, required: true, display_order: 20, sc_template_id: 'cc01_completion' }),
  ...
  fallbackDefinition('ac01_completion', 'access_control', 'AC01 Access control completion and handover', 'One standalone NCP 109 record. Engineer and customer sign on this sheet only.', 'clipboard', { sc_enabled: true, required: true, display_order: 20, sc_template_id: 'ac01_completion' }),
  ...
  fallbackDefinition('ia01_completion', 'intruder_alarm', 'IA01 Intruder alarm completion and handover', 'One standalone NCP 120 record. Engineer and customer sign on this sheet only.', 'clipboard', { sc_enabled: true, required: true, display_order: 20, sc_template_id: 'ia01_completion' }),
