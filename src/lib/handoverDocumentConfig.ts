...
export const FALLBACK_DOCUMENT_DEFINITIONS: HandoverDocumentDefinition[] = [
  fallbackDefinition('sdp', PROJECT_WIDE_DOCUMENT_TYPE_KEY, 'System Design Proposal (SDP)', 'Pacific PDF generated from the Simpro scope. Signatures bind this revision only.', 'file', { required: true, display_order: 5 }),
  fallbackDefinition('cc01_completion', 'cctv', 'CC01 CCTV completion and handover', 'Pacific fillable PDF (NCP 104). Engineer and customer sign on this sheet only.', 'clipboard', { required: true, display_order: 20 }),
  fallbackDefinition('nsi_certificate_cctv', 'cctv', 'NSI Certificate of Compliance', 'Official issued certificate — attach separately. Not generated by these forms.', 'shield', { upload_only: true, display_order: 30 }),
  fallbackDefinition('ac01_completion', 'access_control', 'AC01 Access control completion and handover', 'Pacific fillable PDF (NCP 109). Engineer and customer sign on this sheet only.', 'clipboard', { required: true, display_order: 20 }),
  fallbackDefinition('nsi_certificate_ac', 'access_control', 'NSI Certificate of Compliance', 'Official issued certificate — attach separately. Not generated by these forms.', 'shield', { upload_only: true, display_order: 30 }),
  fallbackDefinition('ia01_completion', 'intruder_alarm', 'IA01 Intruder alarm completion and handover', 'Pacific fillable PDF (NCP 120). Engineer and customer sign on this sheet only.', 'clipboard', { required: true, display_order: 20 }),
  fallbackDefinition('nsi_certificate_intruder', 'intruder_alarm', 'NSI Certificate of Compliance', 'Official issued certificate — attach separately. Not generated by these forms.', 'shield', { upload_only: true, display_order: 30 }),
  fallbackDefinition('fire_commissioning_certificate', 'fire_alarm', 'Fire Alarm Commissioning Certificate', 'Fire alarm commissioning and acceptance certificate', 'shield', { upload_only: true, required: true, display_order: 10 }),
  ...
  fallbackDefinition('fire_detector_test_record', 'fire_alarm', 'Detector Test Record', 'Detector walk-test and functional test record', 'clipboard', { upload_only: true, display_order: 40 }),
  fallbackDefinition('fire_customer_training', 'fire_alarm', 'Customer Training Record', 'Signed training record for customer staff', 'graduation', { upload_only: true, display_order: 50 }),
  fallbackDefinition('handover_intercom', 'intercom', 'Intercom Handover Certificate', 'Signed customer acceptance for intercom systems', 'phone', { upload_only: true, required: true, display_order: 10 }),
  fallbackDefinition('intercom_customer_training', 'intercom', 'Customer Training Record', 'Signed training record for customer staff', 'graduation', { upload_only: true, display_order: 20 }),
  fallbackDefinition('handover_anpr', 'anpr', 'ANPR Handover Certificate', 'Signed customer acceptance for ANPR systems', 'car', { upload_only: true, required: true, display_order: 10 }),
  fallbackDefinition('anpr_customer_training', 'anpr', 'Customer Training Record', 'Signed training record for customer staff', 'graduation', { upload_only: true, display_order: 20 }),
  fallbackDefinition('handover_networking', 'networking', 'Networking Handover Certificate', 'Signed customer acceptance for networking infrastructure', 'network', { upload_only: true, required: true, display_order: 10 }),
  fallbackDefinition('networking_customer_training', 'networking', 'Customer Training Record', 'Signed training record for customer staff', 'graduation', { upload_only: true, display_order: 20 }),
  fallbackDefinition('other_handover_certificate', 'other', 'System Handover Certificate', 'Signed customer acceptance certificate', 'award', { upload_only: true, required: true, display_order: 10 }),
  fallbackDefinition('other_customer_training', 'other', 'Customer Training Record', 'Signed training record for customer staff', 'graduation', { upload_only: true, display_order: 20 }),
  fallbackDefinition('handover_acceptance', PROJECT_WIDE_DOCUMENT_TYPE_KEY, 'System Acceptance Certificate', 'Overall project acceptance signed by customer', 'award', { upload_only: true, required: true, display_order: 10 }),
  fallbackDefinition('handover_training', PROJECT_WIDE_DOCUMENT_TYPE_KEY, 'Training Record', 'Signed training record for customer staff', 'graduation', { upload_only: true, display_order: 20 }),
