...
export const FALLBACK_DOCUMENT_DEFINITIONS: HandoverDocumentDefinition[] = [
  fallbackDefinition('cv01_as_fitted', 'cctv', 'CV01 As-fitted system record', 'Installed camera and recorder schedule. Engineer verification. Quoted qty is not installed proof.', 'file', { sc_enabled: true, required: true, display_order: 10, sc_template_id: 'cv01_as_fitted' }),
  fallbackDefinition('cv02_cameras', 'cctv', 'CV02 Camera and infrastructure record', 'Image, siting, network and power results. Engineer sign-off only.', 'clipboard', { sc_enabled: true, display_order: 20, sc_template_id: 'cv02_cameras' }),
  fallbackDefinition('cv03_commissioning', 'cctv', 'CV03 Commissioning and verification', 'Commissioning checks and tests. Engineer sign-off only.', 'clipboard', { sc_enabled: true, display_order: 30, sc_template_id: 'cv03_commissioning' }),
  fallbackDefinition('cv04_recording', 'cctv', 'CV04 Recording and export verification', 'Retention, playback and export tests. Engineer sign-off; customer results on CV08.', 'clipboard', { sc_enabled: true, display_order: 40, sc_template_id: 'cv04_recording' }),
  fallbackDefinition('cv05_monitoring', 'cctv', 'CV05 Remote monitoring verification', 'Use only for remotely monitored / detector-activated / BS 8418 systems. Engineer sign-off only.', 'clipboard', { sc_enabled: true, display_order: 50, sc_template_id: 'cv05_monitoring' }),
  ...
  fallbackDefinition('cv08_handover', 'cctv', 'CV08 Completion and handover acceptance', 'The routine customer signature. Acknowledges demonstration, documents and operating status.', 'award', { sc_enabled: true, required: true, display_order: 80, sc_template_id: 'cv08_handover' }),
  ...
  fallbackDefinition('cv12_takeover', 'cctv', 'CV12 Takeover survey and condition record', 'Inherited installation survey. Customer signs CV15 only if the takeover is conditional or limited.', 'clipboard', { sc_enabled: true, display_order: 120, sc_template_id: 'cv12_takeover' }),
  ...
  fallbackDefinition('cv14_maintenance', 'cctv', 'CV14 Maintenance and corrective work', 'Visit record. Engineer sign-off only.', 'clipboard', { sc_enabled: true, display_order: 140, sc_template_id: 'cv14_maintenance' }),
  fallbackDefinition('cv15_acceptance', 'cctv', 'CV15 Customer acceptance of change or limitation', 'Extra customer signature only for design changes, reduced coverage or incomplete tests.', 'award', { sc_enabled: true, display_order: 150, sc_template_id: 'cv15_acceptance' }),
  fallbackDefinition('cv16_survey', 'cctv', 'CV16 Survey and test plan', 'Planned survey and tests. Engineer and reviewer; do not repeat CV08/CV15 signatures.', 'clipboard', { sc_enabled: true, display_order: 160, sc_template_id: 'cv16_survey' }),
  ...
  fallbackDefinition('ia01_as_fitted', 'intruder_alarm', 'IA01 As-fitted system record', 'Installed equipment schedule. Engineer verification. Quoted qty is not installed proof.', 'file', { sc_enabled: true, required: true, display_order: 10, sc_template_id: 'ia01_as_fitted' }),
  ...
  fallbackDefinition('ia03_commissioning', 'intruder_alarm', 'IA03 Commissioning and verification', 'Commissioning checks and tests. Engineer sign-off only.', 'clipboard', { sc_enabled: true, display_order: 30, sc_template_id: 'ia03_commissioning' }),
  fallbackDefinition('ia04_arc', 'intruder_alarm', 'IA04 ARC signalling verification', 'End-to-end signalling tests. Engineer sign-off only.', 'clipboard', { sc_enabled: true, display_order: 40, sc_template_id: 'ia04_arc' }),
  fallbackDefinition('ia05_changes', 'intruder_alarm', 'IA05 Changes and remedial actions', 'Design changes, defects and limitations. Customer signs only if a change or limitation needs agreement.', 'file', { sc_enabled: true, display_order: 50, sc_template_id: 'ia05_changes' }),
  ...
  fallbackDefinition('ia10_release', 'intruder_alarm', 'IA10 O&M index and technical release', 'Document completeness and company technical release. Reviewer sign-off.', 'clipboard', { sc_enabled: true, display_order: 100, sc_template_id: 'ia10_release' }),
  ...
  fallbackDefinition('ia14_maintenance', 'intruder_alarm', 'IA14 Maintenance and corrective work', 'Visit record. Engineer sign-off only.', 'clipboard', { sc_enabled: true, display_order: 140, sc_template_id: 'ia14_maintenance' }),
  fallbackDefinition('nsi_certificate_intruder', 'intruder_alarm', 'NSI Certificate of Compliance', 'Official issued certificate — attach separately. Not generated by these forms.', 'shield', { upload_only: true, display_order: 150 }),
